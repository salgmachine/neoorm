...
/**
 * Defines a persistent field, including primitive types or arrays of primitives, complex types, and
 * collections of complex types. (Arrays of complex types are not supported).
 * 
 * @author Taylor Cowan
 */
...
public @interface neo {
	...
	/**
	 * If the value is specified, the node property or relationship will be named accordingly. Defaults to the
	...
	/**
	 * If true the field will be indexed by jo4neo. It is the client's responsibility to ensure uniqueness, as
	 * jo4neo allows multiple entities to be indexed against a single value. Defaults to false.
	 * 
	 * @return
	 */
	...
	/**
	 * Name of a relationship for which this field acts as inverse. All incoming edges with the same name will
	 * be treated as if they were outgoing.
	 * 
	 * @return
	 */
	...
	/**
	 * Declares a {@link TraverserProvider} from which the field (of type Collection) will be generated.
	 * 
	 * @return
	 */
